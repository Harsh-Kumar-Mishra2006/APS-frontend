...
const Navbar = () => {
  ...
  // UPDATED: Instant logout without waiting for server
  const handleLogout = () => {
    ...
    // Call logout API in background (don't await - fire and forget)
  ...
  // Open profile popup instead of dropdown
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              {isAuthenticated ? (
                <>
                  {/* Desktop Profile Button - Opens Popup instead of Dropdown */}
                ...
                {isAuthenticated && (
                  <div className="px-3 pt-4 pb-2 border-t border-blue-600">
                    ...
                    <button 
                      ...
                      className="flex items-center w-full px-3 py-2.5 mt-2 text-red-300 hover:text-red-200 hover:bg-blue-700 rounded-lg"
                    >
